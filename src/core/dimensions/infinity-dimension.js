...
export const InfinityDimensions = {
  ...
  get powerConversionRate() {
    ...
    const y = Ra.unlocks.improvedIpowConversion.isUnlocked ? Math.max(Math.log10(Tesseracts.effectiveCount), 0) : 0; //hpefully won't inflate if we softcap or put scaling in
