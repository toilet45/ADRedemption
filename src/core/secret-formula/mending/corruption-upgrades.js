...
const rebuyable = props => {
  props.cost = () => getHybridCostScaling(
    player.mending.corruptionRebuyables[props.id],
    1e30,
    props.initialCost,
    props.costMult,
    props.costMult / 10,
  ...
  props.effect = () =>{ 
    if (props.effectType === "+" || props.effectType === "-"){
      return effect * player.mending.corruptionRebuyables[props.id];
    }
    return Math.pow(effect, player.mending.corruptionRebuyables[props.id]);
  };
