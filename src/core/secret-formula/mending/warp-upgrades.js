...
export const warpUpgrades = [
  ...
  },
  {
    ...
    id: 8,
    cost: 1e70,
    requirement: "Reach 3e15 TT in Teresa's Reality of Level 9+ Study of Forever Hostile Mend",
  ...
  },
  {
    ...
    id: 9,
    cost: 1e75,
    requirement: "Reach 1.845e9 total galaxies in a Doomed reality without Galaxy Generator",
  ...
  },
  {
    ...
    id: 10,
    cost: 1e60,
    requirement: () => `Reach ${format(1e40)} Memory Crystals.`,
    hasFailed: () => false,
    checkRequirement: () => Currency.raPoints.value.gte(1e40),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    canLock: false,
    lockEvent: "gain a Replicanti Galaxy",
