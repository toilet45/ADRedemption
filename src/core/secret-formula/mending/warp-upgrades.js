...
export const warpUpgrades = [
  ...
  },
  {
    ...
    id: 12,
    cost: 1e90,
    requirement: () => `Reach ${format(Decimal.pow10(5e24))} Antimatter`,
    hasFailed: () => false,
    checkRequirement: () => Currency.antimatter.exponent >= 5e24,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    effect: () => new Decimal(WarpUpgrade(2).effectValue).clampMax(1e300), 
    canLock: false,
    lockEvent: "gain a Replicanti Galaxy",
    description: () => "Warp Upgrade 2 also affects Multiversal Remain gain",
  },
  /*
  {
