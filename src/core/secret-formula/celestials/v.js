...
export const v = {
  ...
  runUnlocks: [
    ...
    },
    {
      ...
      values: [5e12, 7e12, 9e12, 1.1e13, 1.3e13],
    ...
    },
    {
      ...
      values: [3e15, 4.5e15, 6e15, 7.5e15, 8.999e15],
    ...
    },
    {
      ...
      description: value => `Gain ${format(Decimal.pow10(value))} Infinity Points with at least 7 Cursed Glyph equipped and without any Triad Studies.`,
      values: [2e14, 4e14, 6e14, 8e14, 1e15],
    ...
    },
    {
      ...
      condition: () => V.isSuperRunning && player.celestials.effarig.glyphWeights.eternities==100,
      currentValue: () => gainedGlyphLevel().actualLevel,
      formatRecord: x => formatInt(x),
    ...
    },
    {
      ...
      values: [3250, 3500, 3750, 4000],
      condition: () => V.isSuperRunning && player.dilation.active && EternityChallenge(3).isRunning && InfinityChallenge(8).isRunning,
      currentValue: () => Currency.antimatter.value.log10(),
      formatRecord: x => format(Decimal.pow10(x)),
      shardReduction: tiers => 2000 * tiers,
      maxShardReduction: goal => goal - 3250,
      perReductionStep: new Decimal(1e20),
      mode: V_REDUCTION_MODE.DIVISION,
      isSuperHard: true
    },
    {
      id: 15,
      name: "New SuperHard V 4",
      description: value => `Come up a great idea.`,
      values: [12345, 23456, 34567, 45678],
      condition: () => V.isSuperRunning,
      currentValue: () => V.spaceTheorems,
      formatRecord: x => formatInt(x),
      shardReduction: () => 0,
      maxShardReduction: () => 0,
      perReductionStep: 5,
    ...
    {
      id: 16,
      name: "New SuperHard V 5",
      description: value => `Come up a much greater idea.`,
      values: [12345, 23456, 34567, 45678],
      condition: () => V.isSuperRunning,
      currentValue: () => V.spaceTheorems,
      formatRecord: x => formatInt(x),
    ...
    {
      id: 17,
      name: "New SuperHard V 6",
      description: value => `Come up the greatest idea.`,
      values: [12345, 23456, 34567, 45678],
      condition: () => V.isSuperRunning,
      currentValue: () => V.spaceTheorems,
      formatRecord: x => formatInt(x),
