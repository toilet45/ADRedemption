...
export const v = {
  ...
  runUnlocks: [
    ...
    },
    {
      ...
      values: [Decimal.log10('1e5000000000000'), Decimal.log10('1e7500000000000'), Decimal.log10('1e10000000000000'), Decimal.log10('1e12500000000000'), Decimal.log10('1e15000000000000')],
    ...
    },
    {
      ...
      values: [1.5e15, 3e15, 4.5e15, 6e15, 7.5e15],
    ...
    {
      id: 12,
      name: "New SuperHard V 1",
      description: value => `Come up a great idea.`,
      values: [12345, 23456, 34567, 45678, 56789],
      condition: () => V.isRunning,
